            ...
            <ReactLenis root>
                <section className="visualizationsub">
                    ...
                    <div className="visualizationsub-row">
                        <div className="visualizationsub-image manor-1" ref={boxRef1}/>
                    </div>
                    <div className="visualizationsub-row">
                        <div className="visualizationsub-image manor-2" ref={boxRef2} />
                        <div className="visualizationsub-image manor-3" ref={boxRef3} />
                    </div>
                    <div className="visualizationsub-row">
                        <div className="visualizationsub-image manor-4" ref={boxRef4} />
                    </div>
                </section>
                <SectionFooter />
            </ReactLenis>
