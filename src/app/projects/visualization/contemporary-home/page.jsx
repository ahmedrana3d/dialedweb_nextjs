        ...
        <>
            <ReactLenis root>
                <section className="visualizationsub">
                    <h1 className="headline bali-title-text" ref={titleRef} >Contemporary Home</h1>
                    <div className="visualizationsub-row">
                        <div className="visualizationsub-image co-1" ref={boxRef1} />
                        <div className="visualizationsub-image co-2" ref={boxRef2} />
                    </div>
                    <div className="visualizationsub-row">
                        <div className="visualizationsub-image co-3" ref={boxRef3} />
                        <div className="visualizationsub-image co-4" ref={boxRef4} />
                    </div>
                </section>
                <SectionFooter />
            </ReactLenis>
...
export default ContemporaryHomePage;