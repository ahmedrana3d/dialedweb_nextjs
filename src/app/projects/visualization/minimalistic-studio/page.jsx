            ...
            <ReactLenis root>
                <section className="visualizationsub">
                    ...
                    <div className="visualizationsub-row">
                        <div className="visualizationsub-image st-1" ref={boxRef1} />
                        <div className="visualizationsub-image st-2" ref={boxRef2} />
                    </div>
                    <div className="visualizationsub-row">
                        <div className="visualizationsub-image st-3" ref={boxRef3} />
                        <div className="visualizationsub-image st-4" ref={boxRef4} />
                    </div>
                </section>
                <SectionFooter />
            </ReactLenis>
...
export default MinimalisiticStudioPage;