...
const TropicalVacationHomePage = () => {
        ...
        <>
            <ReactLenis root>
                <section className="visualizationsub">
                    <h1 className="headline bali-title-text" ref={titleRef} >Tropical Vacation Home</h1>
                    <div className="visualizationsub-row">
                        <div className="visualizationsub-image tr-1" ref={boxRef1} />
                        <div className="visualizationsub-image tr-2" ref={boxRef2} />
                    </div>
                    <div className="visualizationsub-row">
                        <div className="visualizationsub-image tr-3" ref={boxRef3} />
                        <div className="visualizationsub-image tr-4" ref={boxRef4} />
                    </div>
                </section>
                <SectionFooter />
            </ReactLenis>
...
export default TropicalVacationHomePage;