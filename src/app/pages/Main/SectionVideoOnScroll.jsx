            ...
            <section className="section scroll-video-on-scroll" onMouseEnter={() => { handleMouseEnter(); }} onMouseLeave={() => { handleMouseLeave(); }} >
                <div className="scroll-video-on-scroll-items">
                    <div className="scroll-video-items-wrapper">
                        <h1 className="scroll-section-headline scroll-headline-1" ref={titleRef1} >Grow</h1>
                        <h1 className="scroll-section-headline scroll-headline-2" ref={titleRef2} >your</h1>
                        <h1 className="scroll-section-headline scroll-headline-3 scroll-purple" ref={titleRef3} >Digital</h1>
                        ...
                        <h1 className="scroll-section-headline scroll-headline-4" ref={titleRef4} >Presence,</h1>
                        <h1 className="scroll-section-headline scroll-headline-5" ref={titleRef5} >let</h1>
                        <h1 className="scroll-section-headline scroll-headline-6" ref={titleRef6} >your</h1>
                        <h1 className="scroll-section-headline scroll-headline-7 scroll-purple" ref={titleRef7} >Vision</h1>
                        ...
                        <h1 className="scroll-section-headline scroll-headline-8" ref={titleRef8} >Bloom</h1>
                    </div>
                </div>
